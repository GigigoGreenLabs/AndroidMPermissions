...
public class MainActivity extends SampleActivityBase
    ...
    /**
     * Id to identify a phone permission request.
     */
    ...
    private void doRequestContactsPermissions() {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CAMERA) {
            ...
            if (PermissionUtil.verifyPermissions(grantResults)) {
                Snackbar.make(mLayout, R.string.permision_available_phone, Snackbar.LENGTH_SHORT).show();
            } else {
                Snackbar.make(mLayout, R.string.permissions_not_granted, Snackbar.LENGTH_SHORT).show();
    ...
    public void showPhoneCall(View view) {
        // Check the Phone Permission   android.permission.CALL_PHONE
    ...
    private void requestPhonePermission() {
        // should show the permission request to the user
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.CALL_PHONE)) {
            Snackbar.make(mLayout, R.string.permission_phone_rationale, Snackbar.LENGTH_INDEFINITE)
                    .setAction(R.string.ok, new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
